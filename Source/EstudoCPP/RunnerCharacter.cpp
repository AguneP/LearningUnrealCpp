...
// Reinicia o level se o jogador cai no espinho ou eh pego pela parede
...
{
	// Se houve uma colisao com um Ator valido
	if (OtherActor != nullptr) {
		// Realiza dois cast do OtherActor com o Spike e o WallSpike
		ASpikes* WallSpike = Cast<AWallSpike>(OtherActor);
		ASpikes* Spike = Cast<ASpikes>(OtherActor);

		// Se houver colisao com um dos dois, o jogador "morre" e reinicia o jogo
		if (WallSpike || Spike) {
			GetMesh()->Deactivate();
